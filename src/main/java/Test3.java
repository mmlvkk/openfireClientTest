					...
					if (!createdLocally) {
						chat.addMessageListener(new ChatMessageListener() {
							...
							public void processMessage(Chat chat, Message message) {
								...
								System.out.println("test3 Received message: " + message.getBody());
...
//								}
			...
			Chat chat = chatmanager.createChat("test2@127.0.0.1");
			
			 chat.sendMessage("test3 send messeage is ok 333");
